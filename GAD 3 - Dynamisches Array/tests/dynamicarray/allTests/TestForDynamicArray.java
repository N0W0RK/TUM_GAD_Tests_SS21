...
class TestForDynamicArray {
    ...
    @Test
    void ringQueue() {
        RingQueue ringQueue = new RingQueue(3, 4, new StudentResult());
    ...
    void ringQueueHalfJohannes() {
        RingQueue ringQueue = new RingQueue(2, 5, new StudentResult());
        Assertions.assertEquals("[], size: 0", ringQueue.toString());
        ringQueue.insert(4);
    ...
    void ringQueueBrutalLoop() {
        ...
        ringQueue = new RingQueue(3, 4, new StudentResult());
