...
public class DynamicaRingschlangeTests {
    ...
    public void dynamicStackExamples() {
        ...
        assertArrayEquals(cmpArr, result.getArray(), "Expected Array to be reduced to lower size and only contain 1"
                + " and 2");
    }
    ...
    public void dynamicRingQueueExamples() {
        ...
        queue.insert(8);
        assertArrayEquals(cmpArr, result.getArray(), "Expected 8 to be inserted at index 3 and array size to be "
                "increased");
        ...
        assertThrows(IndexOutOfBoundsException.class, queue::remove, "You should not be able to remove an Item from " +
                "empty queue");
    }
