...
class HashtableTester {
    ...
    private TestModuloHelper mH = new TestModuloHelper();
     ...
     * It checks if the expected behaviour matches the one required by the question.
     */
     ...
     * It does a very basic check of adding values with 1 key and then removing it.
